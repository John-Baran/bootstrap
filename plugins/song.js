...
r_text[8] = `\n enne vilicho...?🧐 \n`;
r_text[9] = `ente per ` + config.BOTSK + `,ninte per donkey, backi ellarum monkey😼😼`;
...
r_text[18] = `enikk njan und ` + config.BOTSK + ` uyir`;
...
r_text[21] = `Kozhikode pazhaya kozhikodellennariyam… pakshe ` + config.BOTSK + ` pazhaya ` + config.BOTSK + ` thanneya...😎\n\n`;
r_text[22] = `Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik ` + config.BOTSK + ``;
r_text[23] = `Ithalla ithinapparam chaadi kadannavananee K.K. ` + config.BOTSK + ``;
