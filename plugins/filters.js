...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Bot.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SKDR, quoted : message.data, ptt: true})
        if (!!message.mention && message.mention[0] == Config.AFNN) {
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Mention.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: Config.SKDR, quoted : message.data, ptt: true})
        }
