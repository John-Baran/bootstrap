    ...
    */
    ...
    setInterval(async () => { 
        ...
        while (getGMTh == 19 && getGMTm == 1) {
            var announce = ''
            if (config.LANG == 'EN') announce = '📢 Testing daily announcements. Report to developer (souravkl11) if you see this'
            if (config.LANG == 'ML') announce = '📢 Testing daily announcements. Report to developer (souravkl11) if you see this'
            if (config.LANG == 'ID') announce = '📢 Testing daily announcements. Report to developer (souravkl11) if you see this'
            
            let video = 'https://c.tenor.com/7QHUtdJRSqMAAAPo/test-printer.mp4'
            let image = 'https://github.com/souravkl11/Raganork/raw/main/NL.png'
...
*/
                        try {
                            ...
                            if (config.LANG == 'EN') {
                                await conn.sendMessage(conn.user.jid, fs.readFileSync("./src/image/Type%20Tool.png"), MessageType.image, { caption: '*ERROR OCCURED FOR RAGANORK:* ```' + error + '```\n\n' });
